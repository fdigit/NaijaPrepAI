...
async function GET(request) {
    try {
        ...
        // Get total lessons
        const totalLessons = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].lesson.count({
            where: {
                userId
            }
        });
        ...
        const quizAttempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quizAttempt.findMany({
            where: {
                userId
            }
        });
        const overallProgress = quizAttempts.length > 0 ? Math.round(quizAttempts.reduce((sum, attempt)=>sum + attempt.score, 0) / quizAttempts.length * 100) / 100 : 0;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            totalLessons,
            studyStreak: streak,
            overallProgress
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9f5a8d4._.js.map