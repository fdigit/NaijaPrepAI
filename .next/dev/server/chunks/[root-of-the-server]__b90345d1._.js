...
"[project]/services/quizService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getQuizAttemptsBySubject",
    ()=>getQuizAttemptsBySubject,
    "getRecentQuizAttemptsBySubject",
    ()=>getRecentQuizAttemptsBySubject,
    "getUserQuizAttempts",
    ()=>getUserQuizAttempts,
    "saveQuizAttempt",
...
;
const saveQuizAttempt = async (data)=>{
    try {
        const attempt = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quizAttempt.create({
            data: {
                userId: data.userId,
...
const getQuizAttemptsBySubject = async (userId)=>{
    try {
        const attempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quizAttempt.findMany({
            where: {
                userId
        ...
        Object.keys(subjectStats).forEach((subject)=>{
            const stats = subjectStats[subject];
            stats.averageScore = stats.totalAttempts > 0 && stats.totalQuestions > 0 ? Math.round(stats.totalCorrect / stats.totalQuestions * 100 * 100) / 100 : 0;
        });
        return subjectStats;
    } catch (error) {
...
const getRecentQuizAttemptsBySubject = async (userId, subject, limit = 10)=>{
    try {
        const attempts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quizAttempt.findMany({
            where: {
                userId,
...
"[project]/app/api/quiz/attempt/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$quizService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/quizService.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        // Save quiz attempt
        const attempt = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$quizService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveQuizAttempt"])({
            userId: session.user.id,
            lessonId,
            totalQuestions,
            correctAnswers,
        ...
        try {
            let xpEarned = __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["XP_VALUES"].COMPLETE_QUIZ;
            if (score === 100) {
                xpEarned += __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["XP_VALUES"].QUIZ_PERFECT_SCORE; // Bonus for perfect score
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["awardXP"])(session.user.id, xpEarned, `Completed quiz (${score.toFixed(0)}%)`);
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studySessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordQuizCompletion"])(session.user.id, lessonId, timeSpent);
            // Update subject progress
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSubjectProgress"])(session.user.id, lesson.subject, {
                quizzesPassed: 1,
                xpEarned
            });
            // Check for badges
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b90345d1._.js.map