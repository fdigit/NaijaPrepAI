...
async function PATCH(request) {
    try {
        ...
        let normalizedClassLevel = undefined;
        if (classLevel) {
            ...
            if (validClassLevels.includes(normalized)) {
                normalizedClassLevel = normalized;
            } else {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6bf61ee5._.js.map