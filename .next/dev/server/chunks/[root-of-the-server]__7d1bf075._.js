...
"[project]/services/lessonService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const mapTermToPrisma = (term)=>{
    if (term === 'First Term' || term === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].FIRST) return __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].FIRST;
    if (term === 'Second Term' || term === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].SECOND) return __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].SECOND;
    if (term === 'Third Term' || term === __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].THIRD) return __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].THIRD;
    // Default fallback
    return __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Term"].FIRST;
};
// Map TypeScript ClassLevel enum to Prisma ClassLevel enum
const mapClassLevelToPrisma = (classLevel)=>{
...
const saveLesson = async (selection, content, userId)=>{
    try {
        ...
        const lesson = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].lesson.create({
            data: {
                ...
                theoryQuestion: content.theoryQuestion,
                ...userId && {
                    userId
                }
            }
...
const getLessons = async (filters, limit)=>{
    try {
...
const getLessonById = async (id)=>{
    try {
        const lesson = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].lesson.findUnique({
            where: {
                id
            }
        });
...
const deleteLesson = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].lesson.delete({
            where: {
                id
            }
        });
...
"[project]/services/studySessionService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
;
async function recordStudySession(userId, options) {
    try {
        const today = new Date();
        today.setHours(0, 0, 0, 0);
        // Check if a session already exists for today
        const existingSession = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].studySession.findFirst({
            where: {
                userId,
                date: {
                    gte: today,
        ...
        if (existingSession) {
            ...
            if (options?.duration) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].studySession.update({
                    where: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].studySession.create({
                data: {
                    userId,
                    date: today,
...
async function recordLessonGeneration(userId, lessonId) {
    await recordStudySession(userId, {
        lessonId,
        duration: 10
    });
}
async function recordQuizCompletion(userId, lessonId, timeSpent) {
...
async function recordExamPrepCompletion(userId, timeSpent) {
...
async function getWeeklyStats(userId) {
    ...
    const sessions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].studySession.findMany({
        where: {
            userId,
            date: {
                gte: startOfWeek,
...
"[project]/app/api/lessons/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$lessonService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/lessonService.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studySessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/studySessionService.ts [app-route] (ecmascript)");
const runtime = 'nodejs';
;
;
;
    ...
    try {
        ...
        if (!session?.user?.id) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                debug: ("TURBOPACK compile-time truthy", 1) ? 'Session exists but user.id is missing. Check session callback.' : "TURBOPACK unreachable"
            }, {
                status: 401
            });
        }
        ...
        const lesson = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$lessonService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveLesson"])(body.selection, body.content, session.user.id);
        // Award XP for generating lesson
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["awardXP"])(session.user.id, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["XP_VALUES"].GENERATE_LESSON, 'Generated a lesson');
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDailyStreak"])(session.user.id);
            // Record study session for weekly progress
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$studySessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordLessonGeneration"])(session.user.id, lesson.id);
            // Update subject progress
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSubjectProgress"])(session.user.id, body.selection.subject, {
                lessonsCompleted: 1,
                xpEarned: __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["XP_VALUES"].GENERATE_LESSON
            });
            // Check for badges
            const user = await __turbopack_context__.A("[project]/lib/prisma.ts [app-route] (ecmascript, async loader)").then((m)=>m.prisma.user.findUnique({
                    where: {
                        id: session.user.id
                    },
                    include: {
            ...
            if (user) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$gamificationService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkAndAwardBadges"])(session.user.id, {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(lesson, {
            status: 201
        });
    } catch (error) {
        console.error('Error saving lesson:', error);
...
async function GET(request) {
    try {
        ...
        if (searchParams.get('classLevel')) {
            filters.classLevel = searchParams.get('classLevel');
        }
        if (searchParams.get('subject')) {
            filters.subject = searchParams.get('subject');
        }
        if (searchParams.get('term')) {
            filters.term = searchParams.get('term');
        }
        ...
        const lessons = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$lessonService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLessons"])(filters, limit);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(lessons);
    } catch (error) {
        console.error('Error fetching lessons:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7d1bf075._.js.map