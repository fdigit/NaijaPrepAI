...
"[project]/app/api/exam-prep/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (classLevelParam && classLevelParam !== 'all') {
            ...
            filters.classLevel = normalized;
        }
        // Only filter by isActive if explicitly provided
        if (isActiveParam !== null && isActiveParam !== undefined) {
            filters.isActive = isActiveParam === 'true';
        }
        const examPreps = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$examPrepService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getExamPreps"])(session.user.id, filters);
        ...
        const examPrepsWithAttempts = await Promise.all(examPreps.map(async (examPrep)=>{
            try {
                const attemptStats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$examPrepService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getExamPrepAttemptStats"])(session.user.id, examPrep.id);
                return {
                    id: examPrep.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            examPreps: examPrepsWithAttempts
        });
    } catch (error) {
        console.error('Error fetching exam preps:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        if (classLevel) {
            ...
            const validClassLevels = Object.values(__TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"]);
            ...
            const prismaToTsMap = {
                'JSS1': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].JSS1,
                'JSS2': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].JSS2,
                'JSS3': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].JSS3,
                'SSS1': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].SSS1,
                'SSS2': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].SSS2,
                'SSS3': __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].SSS3
            };
            finalClassLevel = prismaToTsMap[user.classLevel] || __TURBOPACK__imported__module__$5b$project$5d2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ClassLevel"].SSS1;
        }
        const examPrep = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$examPrepService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateExamPrep"])(session.user.id, subject, finalClassLevel, examName, questionCount || 50);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            examPrep
        }, {
            status: 201
...
async function DELETE(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$examPrepService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteExamPrep"])(id, session.user.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__531bd75d._.js.map